...
var peanutsGang = ['charlie brown', 'snoopy', 'lionel', 'lucy', 'woodstock'];
...
var myFav = 'My favorite Peanuts character is ' + (peanutsGang[1]);
console.log(myFav);
...
var deposit = 1000;
var priorBalance = 8000;
var newBalance = priorBalance + deposit;
...
var bitcoinBal = 2;
var extraBitcoin = 1;
var newBitcoinBal = bitcoinBal + extraBitcoin;
console.log(newBitcoinBal);
...
var evenBalanceCheck = newSavingsBal%2 === 0;
console.log(evenBalanceCheck);
if (newSavingsBal%2 === 0)
 {var newNewBalance = newSavingsBal + 500;
    console.log(newNewBalance);}
 else
 {console.log(newSavingsBal);}
...
var taxAmount = newNewBalance*.3;
console.log(taxAmount);

var afterTaxBalance = newNewBalance - taxAmount
console.log(afterTaxBalance);
...
var interestRate = .20;
var quarterIntRate = .20/4;
var earnedInt = afterTaxBalance * quarterIntRate;
console.log(earnedInt);
